...
\begin{itemize}
  ...
  % Study Abroad in Queretero, Mexico

  % Include GPA with each education item?

  % Consider writing out BS and MS fully
...
% Consider ending descriptions with periods

% Fix lines that barely go to next line

% Fix tenses of Grad position

% Update verbs and wording of experience descriptions

% Explain what Palantir is.

% Position, Employer (bold)
% Location, Date (italics)
